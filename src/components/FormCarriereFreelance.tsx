      ...
      >
        ...
        {step === 1 && (
          <div data-step="1">
            ...
            <input
              ...
              onChange={handleChange}
            />
            <div className="invalid-feedback">Prénom invalide</div>
        ...
        {step === 2 && (
          <div data-step="2">
            ...
            <div className={`form-control p-0 mb-1 ${phoneError ? "is-invalid" : ""}`}>
              <PhoneInput
                international
                defaultCountry="HT"
            ...
            <input
              ...
              onChange={handleChange}
            />
            <div className="invalid-feedback">Adresse invalide</div>
